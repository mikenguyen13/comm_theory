...
According to [@Baxter_2008], interpersonal communication is "the
...
one ultimate theory that has its own sovereignty [@Higgins_2004]. Each
theory has its own assumptions. "Making different predictions is not hte
same as making competing predictions". [@Higgins_2004]. a phenomenon can
...
-   **situational** set: "the given, unalterable features of a
    communication setting".\
-   **dispositional** set: "our past experience and our future
...
-   Relationship Constellations
    ...
    -   not only actual actions by the constellation members that affect
        ...
        also affects you. [@Surra_1990] + people are influenced by the
...
1.  Since humans live in worlds of meaning that are constantly
    constructed, none can affect the process significantly.
2.  Culture figures (ethnicity, gender, age, social class, sexual
    orientation, etc) affect communication and how you respond to it.
3.  we collaboratively build the sense of selves (i.e., identity) when
