...
\item
  According to \citep{Mehrabian_1967}, nonverbal immediacy are ``communicative behaviors used to enhance physical or psychological closeness and reduce interpersonal distance'' (e.g., touching, nodding, smiling).
\item
...
\begin{itemize}
\item
  Using social identity theory, \citep{Stephens_2013} hypothesize and find that people's identification with a message source (HIT- health information technologies) mediates the effect of social media on outcomes.
\item
  ...
  \tightlist
  \item
    Organizational identification increase affect involvement, satisfaction and organizational commitment \citep{Ashforth_2008}
  \end{itemize}
\item
  HIT can be either
